                    ...
                    onsubmit="return validar()">
                        ...
                        <div class="form-row" >
                          <div class="col-md-4 mb-3">
                            ...
                            <input id="nombre" type="text" name="nombre" maxlength="30" placeholder="Nombre" required
                          ...
                          <div class="col-md-4 mb-3">
                            ...
                            <!--primero colocamos parametros que vamos a pasar por php y al ultimo el estilo-->
                            <input id="apellido" type="text" name="apellido" maxlength="50" placeholder="Apellido" required
                            class="form-control is-valid">
                          ...
                          <div class="col-md-4 mb-3">
                            ...
                            <!--primero colocamos parametros que vamos a pasar por php y al ultimo el estilo-->
                            <input id="telefono" type="int" name="telefono" required required maxlength="11"
                          ...
                          <div class="col-md-4 mb-3">
                            ...
                            <div class="input-group">
                              <div class="input-group-prepend">
                                ...
                                <!--primero colocamos parametros que vamos a pasar por php y al ultimo el estilo-->
                                <input id="usuario" type="text" name="usuario" required required maxlength="6"
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            placeholder="password" required required maxlength="6"
                            class="form-control is-valid">
